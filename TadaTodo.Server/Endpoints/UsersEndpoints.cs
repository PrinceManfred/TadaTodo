...
public static class UsersEndpoints
{
    ...
    private static async Task<Results<Created<UserDto>, BadRequest<string>, Conflict<string>>> Register(
        UserLoginDto userLogin, HttpContext httpContext, TadaTodoContext context, IValidator<UserLoginDto> validator)
    {
        ...
        todoList.TodoItems.Add(new TodoItem("Click the \"Save\" button on the bottom right to save your changes.",
            false));
        todoList.TodoItems.Add(
            new TodoItem("Click your username in the top right of the site and check out your stats.", false));
    ...
    private static async Task<Results<Ok<UserDto>, BadRequest>> Login(UserLoginDto userLogin, HttpContext httpContext,
